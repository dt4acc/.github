...
| **dt4acc** provides the required infrastructure to build digital twins
  for particle accelerators.
| It delivers most of the implementation (\~90%), so new twins mainly
  require adapting the control system interface.

| A dt4acc digital twin is primarily a **virtual accelerator (test
  bench)** used to develop and test control software before the real
